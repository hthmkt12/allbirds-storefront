...
Working directory: F:/Allbirds/.agents/teamwork_preview_auditor_cms_setup
...
Write your report to `F:/Allbirds/.agents/teamwork_preview_auditor_cms_setup/handoff.md` and complete with status DONE.
