...
Write a progress update to `F:/Allbirds/.agents/worker_final_harden/progress.md` and a handoff report at `F:/Allbirds/.agents/worker_final_harden/handoff.md`.

Work directory: F:/Allbirds/.agents/worker_final_harden
