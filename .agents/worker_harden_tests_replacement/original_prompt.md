...
Write a progress update to `F:/Allbirds/.agents/worker_harden_tests_replacement/progress.md` and a handoff report at `F:/Allbirds/.agents/worker_harden_tests_replacement/handoff.md`.
...
Work directory: F:/Allbirds/.agents/worker_harden_tests_replacement
